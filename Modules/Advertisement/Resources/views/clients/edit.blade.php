...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <form id="client-form" action="{{ route('clients.update', $client->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input type="number" name="phone" class="form-control" value="{{ old('phone', $client->phone) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="alternate_phone" class="form-control" value="{{ old('alternate_phone', $client->alternate_phone) }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea name="address" class="form-control summernote">{{ old('address', $client->address) }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="company_phone" class="form-control" value="{{ old('company_phone', $client->company_phone) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_pan" class="form-control" value="{{ old('company_pan', $client->company_pan) }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="company_address" class="form-control summernote">{{ old('company_address', $client->company_address) }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="company_logo" class="form-control-file border" accept="image/*">

                                            @error('company_logo') <p class="text-danger">{{ $message }}</p> @enderror

                                            @if($client->company_logo)
                                            <div class="mt-2">
                                                <img src="{{ asset('upload/images/company/'.$client->company_logo) }}" width="150px" class="img-thumbnail">
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="owner_name" class="form-control" value="{{ old('owner_name', $client->owner_name) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="owner_email" class="form-control" value="{{ old('owner_email', $client->owner_email) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="owner_phone" class="form-control" value="{{ old('owner_phone', $client->owner_phone) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="mt-2">
                                                <img src="{{ asset('upload/images/owner/'.$client->owner_image) }}" width="150px" class="img-thumbnail">
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="owner_address" class="form-control summernote">{{ old('owner_address', $client->owner_address) }}</textarea>
                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <input type="checkbox" name="status" {{ $client->status ? 'checked' : '' }} data-bootstrap-switch data-off-color="danger" data-on-color="success">
