...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <form id="product-form" action="{{ route('advertisements.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <button class="btn btn-info"><i class="fa fa-plus"></i> Create Advertisement <i class="bi bi-check"></i></button>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="link" class="form-control" placeholder="Enter Contact " value="{{ old('link') }}">
                                    @error('link')
                                    <p style="color: red">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="position" class="form-control" placeholder="Enter position" value="{{ old('position') }}" required>
                                    @error('position')
                                    <p style="color: red">{{ $message }}</p>
                                    @enderror
                                </div>
