<div class="modal fade" id="editType{{ $value->id }}" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('types.update', $value->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            @if ($value->image)
                            <img src="{{ asset('upload/images/News_Type/'.$value->image) }}" width="120">
                            @endif
                        </div>
